...
# License::   MIT
#
# Details::   A cache type class that stores details of all possible
#             associations on AR classes.
#
...
module DataShift
  class MethodDictionary
    ...
    def self.for?(klass)
      !(has_many[klass] || belongs_to[klass] || has_one[klass] || assignments[klass]).nil?
    end
